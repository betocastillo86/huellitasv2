// <auto-generated />
//-----------------------------------------------------------------------
// <copyright file="SeedingLocations.cs" company="Gabriel Castillo">
...
namespace Huellitas.Data.Migrations
{
    ...
    /// seeding locations
    /// </summary>
    public static class SeedingLocations
    {
        /// <summary>
        ...
        public static void Seed(HuellitasContext context)
        {
            ...
            var locations = new Location[]
            {
                new Location() {
                    Name = "Colombia",
                    ChildrenLocations = new Location[]
                {
                    new Location() {
                        Name = "Antioquia",
                        ChildrenLocations = new Location[]
                ...
                new Location() { Name = "Perú", ChildrenLocations = new Location[]
                {
                    new Location() { Name = "DISTRITO QUE LA CONFORMAN" },
                    new Location() { Name = "BAGUA GRANDE" },
                    new Location() { Name = "CHACHAPOYAS" },
                    new Location() { Name = "CHIMBOTE" },
                    new Location() { Name = "COISHCO" },
                    new Location() { Name = "NUEVO CHIMBOTE" },
                    new Location() { Name = "HUARAZ" },
                    new Location() { Name = "INDEPENDENCIA" },
                    new Location() { Name = "CASMA" },
                    new Location() { Name = "ABANCAY" },
                    new Location() { Name = "TAMBURCO" },
                    new Location() { Name = "ANDAHUAYLAS" },
                    new Location() { Name = "SAN JERÓNIMO" },
                    new Location() { Name = "TALAVERA" },
                    new Location() { Name = "AREQUIPA" },
                    new Location() { Name = "ALTO SELVA ALEGRE" },
                    new Location() { Name = "CAYMA" },
                    new Location() { Name = "CERRO COLORADO" },
                    new Location() { Name = "JACOBO HUNTER" },
                    new Location() { Name = "MARIANO MELGAR" },
                    new Location() { Name = "MIRAFLORES" },
                    new Location() { Name = "PAUCARPATA" },
                    new Location() { Name = "SABANDÍA" },
                    new Location() { Name = "SACHACA" },
                    new Location() { Name = "SOCABAYA" },
                    new Location() { Name = "TIABAYA" },
                    new Location() { Name = "YANAHUARA" },
                    new Location() { Name = "JOSÉ LUIS BUSTAMANTE Y RIVERO" },
                    new Location() { Name = "CAMANÁ" },
                    new Location() { Name = "JOSE MARÍA QUIMPER" },
                    new Location() { Name = "SAMUEL PASTOR" },
                    new Location() { Name = "MOLLENDO" },
                    new Location() { Name = "AYACUCHO" },
                    new Location() { Name = "CARMEN ALTO" },
                    new Location() { Name = "SAN JUAN BAUTISTA" },
                    new Location() { Name = "JESUS NAZARENO" },
                    new Location() { Name = "HUANTA" },
                    new Location() { Name = "CAJAMARCA" },
                    new Location() { Name = "LOS BAÑOS DEL INCA" },
                    new Location() { Name = "JAÉN" },
                    new Location() { Name = "CUSCO" },
                    new Location() { Name = "SAN JERÓNIMO" },
                    new Location() { Name = "SAN SEBASTIÁN" },
                    new Location() { Name = "SANTIAGO" },
                    new Location() { Name = "WANCHAQ" },
                    new Location() { Name = "SICUANI" },
                    new Location() { Name = "SANTA ANA" },
                    new Location() { Name = "ESPINAR" },
                    new Location() { Name = "HUANCAVELICA" },
                    new Location() { Name = "ASCENCIÓN" },
                    new Location() { Name = "HUÁNUCO" },
                    new Location() { Name = "AMARILIS" },
                    new Location() { Name = "PILLCO MARCA" },
                    new Location() { Name = "RUPA-RUPA" },
                    new Location() { Name = "ICA" },
                    new Location() { Name = "LA TINGUINA" },
                    new Location() { Name = "PARCONA" },
                    new Location() { Name = "SUBTANJALLA" },
                    new Location() { Name = "CHINCHA ALTA" },
                    new Location() { Name = "GROCIO PRADO" },
                    new Location() { Name = "PUEBLO NUEVO" },
                    new Location() { Name = "SUNAMPE" },
                    new Location() { Name = "PISCO" },
                    new Location() { Name = "SAN ANDRÉS" },
                    new Location() { Name = "SAN CLEMENTE" },
                    new Location() { Name = "TÚPAC AMARU INCA" },
                    new Location() { Name = "NAZCA" },
                    new Location() { Name = "VISTA ALEGRE" },
                    new Location() { Name = "HUANCAYO" },
                    new Location() { Name = "CHILCA" },
                    new Location() { Name = "EL TAMBO" },
                    new Location() { Name = "TARMA" },
                    new Location() { Name = "LA OROYA" },
                    new Location() { Name = "SANTA ROSA DE SACCO" },
                    new Location() { Name = "JAUJA" },
                    new Location() { Name = "TRUJILLO" },
                    new Location() { Name = "EL PORVENIR" },
                    new Location() { Name = "FLORENCIA DE MORA" },
                    new Location() { Name = "LA ESPERANZA" },
                    new Location() { Name = "VÍCTOR LARCO HERRERA" },
                    new Location() { Name = "CHEPÉN" },
                    new Location() { Name = "GUADALUPE" },
                    new Location() { Name = "CASA GRANDE" },
                    new Location() { Name = "PACASMAYO" },
                    new Location() { Name = "HUAMACHUCO" },
                    new Location() { Name = "LAREDO" },
                    new Location() { Name = "MOCHE" },
                    new Location() { Name = "CHICLAYO" },
                    new Location() { Name = "JOSE LEONARDO ORTIZ" },
                    new Location() { Name = "LA VICTORIA" },
                    new Location() { Name = "PIMENTEL" },
                    new Location() { Name = "LAMBAYEQUE" },
                    new Location() { Name = "FERREÑAFE" },
                    new Location() { Name = "PUEBLO NUEVO" },
                    new Location() { Name = "TUMAN" },
                    new Location() { Name = "MONSEFU" },
                    new Location() { Name = "LIMA" },
                    new Location() { Name = "ANCÓN" },
                    new Location() { Name = "ATE" },
                    new Location() { Name = "BARRANCO" },
                    new Location() { Name = "BRENA" },
                    new Location() { Name = "CARABAYLLO" },
                    new Location() { Name = "CHACLACAYO" },
                    new Location() { Name = "CHORRILLOS" },
                    new Location() { Name = "CIENEGUILLA" },
                    new Location() { Name = "COMAS" },
                    new Location() { Name = "EL AGUSTINO" },
                    new Location() { Name = "INDEPENDENCIA" },
                    new Location() { Name = "JESÚS MARÍA" },
                    new Location() { Name = "LA MOLINA" },
                    new Location() { Name = "LA VICTORIA" },
                    new Location() { Name = "LINCE" },
                    new Location() { Name = "LOS OLIVOS" },
                    new Location() { Name = "LURIGANCHO" },
                    new Location() { Name = "LURIN" },
                    new Location() { Name = "MAGDALENA DEL MAR" },
                    new Location() { Name = "MAGDALENA VIEJA" },
                    new Location() { Name = "MIRAFLORES" },
                    new Location() { Name = "PACHACAMAC" },
                    new Location() { Name = "PUCUSANA" },
                    new Location() { Name = "PUENTE PIEDRA" },
                    new Location() { Name = "PUNTA HERMOSA" },
                    new Location() { Name = "PUNTA NEGRA" },
                    new Location() { Name = "RÍMAC" },
                    new Location() { Name = "SAN BARTOLO" },
                    new Location() { Name = "SAN BORJA" },
                    new Location() { Name = "SAN ISIDRO" },
                    new Location() { Name = "SAN JUAN DE LURIGANCHO" },
                    new Location() { Name = "SAN JUAN DE MIRAFLORES" },
                    new Location() { Name = "SAN LUIS" },
                    new Location() { Name = "SAN MARTÍN DE PORRES" },
                    new Location() { Name = "SAN MIGUEL" },
                    new Location() { Name = "SANTA ANITA" },
                    new Location() { Name = "SANTA MARÍA DEL MAR" },
                    new Location() { Name = "SANTA ROSA" },
                    new Location() { Name = "SANTIAGO DE SURCO" },
                    new Location() { Name = "SURQUILLO" },
                    new Location() { Name = "VILLA EL SALVADOR" },
                    new Location() { Name = "SURQUILLO" },
                    new Location() { Name = "VILLA EL SALVADOR" },
                    new Location() { Name = "VILLA MARÍA DEL TRIUNFO" },
                    new Location() { Name = "CALLAO" },
                    new Location() { Name = "BELLAVISTA" },
                    new Location() { Name = "CARMEN DE LA LEGUA REYNOSO" },
                    new Location() { Name = "LA PERLA" },
                    new Location() { Name = "LA PUNTA" },
                    new Location() { Name = "VENTANILLA" },
                    new Location() { Name = "HUACHO" },
                    new Location() { Name = "CALETA DE CARQUÍN" },
                    new Location() { Name = "HUALMAY" },
                    new Location() { Name = "HUARAL" },
                    new Location() { Name = "SAN VICENTE DE CAÑETE" },
                    new Location() { Name = "IMPERIAL" },
                    new Location() { Name = "BARRANCA" },
                    new Location() { Name = "HUAURA" },
                    new Location() { Name = "SANTA MARÍA" },
                    new Location() { Name = "PARAMONGA" },
                    new Location() { Name = "PATIVILCA" },
                    new Location() { Name = "CHANCAY" },
                    new Location() { Name = "MALA" },
                    new Location() { Name = "NUEVO IMPERIAL" },
                    new Location() { Name = "SUPE" },
                    new Location() { Name = "SUPE PUERTO" },
                    new Location() { Name = "IQUITOS" },
                    new Location() { Name = "PUNCHANA" },
                    new Location() { Name = "BELÉN" },
                    new Location() { Name = "SAN JUAN BAUTISTA" },
                    new Location() { Name = "YURIMAGUAS" },
                    new Location() { Name = "TAMBOPATA" },
                    new Location() { Name = "ILO" },
                    new Location() { Name = "MOQUEGUA" },
                    new Location() { Name = "SAMEGUA" },
                    new Location() { Name = "CHAUPIMARCA" },
                    new Location() { Name = "SIMON BOLIVAR" },
                    new Location() { Name = "YANACANCHA" },
                    new Location() { Name = "PIURA" },
                    new Location() { Name = "CASTILLA" },
                    new Location() { Name = "SULLANA" },
                    new Location() { Name = "BELLAVISTA" },
                    new Location() { Name = "PARINAS" },
                    new Location() { Name = "CATACAOS" },
                    new Location() { Name = "PAITA" },
                    new Location() { Name = "CHULUCANAS" },
                    new Location() { Name = "SECHURA" },
                    new Location() { Name = "JULIACA" },
                    new Location() { Name = "PUNO" },
                    new Location() { Name = "AYAVIRI" },
                    new Location() { Name = "ILAVE" },
                    new Location() { Name = "TARAPOTO" },
                    new Location() { Name = "LA BANDA DE SHILCAYO" },
                    new Location() { Name = "MORALES" },
                    new Location() { Name = "MOYOBAMBA" },
                    new Location() { Name = "RIOJA" },
                    new Location() { Name = "TACNA" },
                    new Location() { Name = "ALTO DE LA ALIANZA" },
                    new Location() { Name = "CIUDAD NUEVA" },
                    new Location() { Name = "POCOLLAY" },
                    new Location() { Name = "CORONEL GREGORIO ALBARRACIN LANCHIPA" },
                    new Location() { Name = "TUMBES" },
                    new Location() { Name = "CALLARIA" },
                    new Location() { Name = "YARINACOCHA" },
                }
                }
            };
