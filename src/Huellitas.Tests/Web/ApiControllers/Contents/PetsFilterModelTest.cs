...
namespace Huellitas.Tests.Web.ApiControllers.Contents
{
    ...
    /// </summary>
    [TestFixture]
    public class PetsFilterModelTest : BaseTest
    {
        /// <summary>
        ...
        public void InvalidAge()
        {
            ...
            var filter = new PetsFilterModel();
            filter.Age = "-5";
            Assert.IsFalse(filter.IsValid(false, this.workContext.Object, out selectedFilters));
            filter.Age = "s-1";
            Assert.IsFalse(filter.IsValid(false, this.workContext.Object, out selectedFilters));
            filter.Age = "1-s";
            Assert.IsFalse(filter.IsValid(false, this.workContext.Object, out selectedFilters));
        ...
        public void InvalidShelter()
        {
            ...
            Assert.IsFalse(filter.IsValid(true, this.workContext.Object, out selectedFilters));
